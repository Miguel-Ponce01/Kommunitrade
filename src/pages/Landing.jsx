...
export default function Landing() {
  ...
  return (
    <div className="editorial-landing animate-fade-in">
      ...
      <div style={{ padding: '0 3rem', marginBottom: '6rem' }}>
      ...
      <section style={{ padding: '0 var(--container-padding) var(--section-gap)' }}>
      ...
      <section style={{ background: 'var(--card-bg)', padding: '8rem 3rem', marginBottom: '8rem' }}>
